...
func (app *application) userSignup(w http.ResponseWriter, r *http.Request) {
	data := app.newTemplateData(r)
	data.Form = userSiginupForm{}
	app.render(w, http.StatusOK, "signup.tmpl", data)
}

func (app *application) userSignupPost(w http.ResponseWriter, r *http.Request) {
	var form userSiginupForm
	...
	form.CheckField(validator.NotBlank(form.Password), "password", "Thsi field cannot be blank")
	form.CheckField(validator.MinChars(form.Password, 8), "passwowrd", "This field must be at least 8 characters long")
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.NotBlank(form.Email), "email", "This field cannot be blank")
	form.CheckField(validator.Matches(form.Email, validator.EmailRX), "email", "This feild must be a valid email address")
...
func (app *application) userLogout(w http.ResponseWriter, r *http.Request) {
	...
	// remove authenticateUserID from session
